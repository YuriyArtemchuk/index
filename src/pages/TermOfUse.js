      ...
      <div className="container">
        <div className="row">
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            <p>Welcome to AM Consulting & Management!</p>
            <p>
              These terms and conditions outline the rules and regulations for
              the use of AM Consulting & Management's Website, located at
              McKinsey & Company.
            </p>
            <p>
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use AM Consulting & Management if
            ...
            <p>
              We employ the use of cookies. By accessing AM Consulting &
              Management, you agreed to use cookies in agreement with the AM
              Consulting & Management's Privacy Policy.{" "}
            </p>
            <p>
            ...
            <p>
              Unless otherwise stated, AM Consulting & Management and/or its
              licensors own the intellectual property rights for all material on
              McKinsey & Company. All intellectual property rights are reserved.
              You may access this from AM Consulting & Management for your own
              personal use subjected to restrictions set in these terms and
              conditions.
            </p>
            <p>You must not:</p>
            <ul>
              <li>Republish material from AM Consulting & Management</li>
              <li>
                Sell, rent or sub-license material from AM Consulting &
                Management
              </li>
              <li>
                Reproduce, duplicate or copy material from AM Consulting &
                Management
              </li>
              <li>Redistribute content from AM Consulting & Management</li>
            </ul>
            <p>
            ...
            <p>
              ...
              AM Consulting & Management does not filter, edit, publish or
              review Comments prior to their presence on the website. Comments
              do not reflect the views and opinions of AM Consulting &
              Management,its agents and/or affiliates. Comments reflect the
              views and opinions of the person who post their views and
              opinions. To the extent permitted by applicable laws, AM
              Consulting & Management shall not be liable for the Comments or
            ...
            <p>
              AM Consulting & Management reserves the right to monitor all
            ...
            <p>
              You hereby grant AM Consulting & Management a non-exclusive
            ...
            <p>
              ...
              from the visibility of the hyperlink compensates the absence of AM
              Consulting & Management; and (d) the link is in the context of
            ...
            <p>
              ...
              by sending an e-mail to AM Consulting & Management. Please include
            ...
            <p>
              No use of AM Consulting & Management's logo or other artwork will
