const PrivitePolicy = () => {
  return (
    <div className="container">
      <div className="row">
        <h1>Privacy Policy for AM Consulting & Management</h1>
        <p>
          At AM Consulting & Management, accessible from AM Consulting &
          Management, one of our main priorities is the privacy of our visitors.
          This Privacy Policy document contains types of information that is
          collected and recorded by AM Consulting & Management and how we use
          it.
        </p>
        <p>
        ...
        <p>
          ...
          shared and/or collect in AM Consulting & Management. This policy is
        ...
        <h2>Log Files</h2>
        <p>
          AM Consulting & Management follows a standard procedure of using log
        ...
        <p>
          ...
          advertising partners of AM Consulting & Management.
        </p>
        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on AM Consulting & Management,
        ...
        <p>
          Note that AM Consulting & Management has no access to or control over
          these cookies that are used by third-party advertisers.
        </p>
        <h2>Third Party Privacy Policies</h2>
        <p>
          AM Consulting & Management's Privacy Policy does not apply to other
        ...
        <p>
          AM Consulting & Management does not knowingly collect any Personal
